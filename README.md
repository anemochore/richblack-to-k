...
**용어:** 프로그램 이름에서는 rich black이라는 말을 사용하지만, impure black/gray 혹은 composite black이 더 적절한 용어다.
